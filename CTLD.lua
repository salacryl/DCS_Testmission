--[[
 ...
 -- *********************  USER CONFIGURATION ******************************
 -- ************************************************************************
 ctld.staticBugWorkaround = true --  DCS had a bug where destroying statics would cause a crash. If this happens again, set this to TRUE
 ...
 ctld.maximumDistanceLogistic = 1200 -- max distance from vehicle to logistics to allow a loading or spawning operation
 ...
 ctld.spawnableCrates = {
     ...
     ["Ground Forces"] = {
         ...
         { weight = 1000, desc = "Abrams", unit = "M-1 Abrams", side = 2, cratesRequired = 2 },
         { weight = 1001, desc = "Challenger", unit = "Challenger2", side = 2, cratesRequired = 3 },
         { weight = 1002, desc = "Chieftain", unit = "Chieftain_mk3", side = 2, cratesRequired = 2 },
         { weight = 1003, desc = "Leopard 2A6M", unit = "Leopard-2", side = 2, cratesRequired = 3 },
         { weight = 1002, desc = "Merkava", unit = "Merkava_Mk4", side = 2, cratesRequired = 2 },
         { weight = 900, desc = "Bradley", unit = "M-2 Bradley", side = 2, cratesRequired = 2 },
         { weight = 901, desc = "LAV-25", unit = "LAV-25", side = 2, cratesRequired = 1 },
         { weight = 902, desc = "Stryker", unit = "M1128 Stryker MGS", side = 2, cratesRequired = 2 },
         { weight = 903, desc = "Warrior", unit = "MCV-80", side = 2, cratesRequired = 2 },
         { weight = 904, desc = "Marder", unit = "Marder", side = 2, cratesRequired = 2 },
         { weight = 905, desc = "Linebacker", unit = "M6 Linebacker", side = 2, cratesRequired = 2 },
         { weight = 906, desc = "Gepard", unit = "Gepard", side = 2, cratesRequired = 1 },
         { weight = 907, desc = "Vulcan", unit = "Vulcan", side = 2, cratesRequired = 1 },
         { weight = 908, desc = "Roland", unit = "Roland ADS", side = 2, cratesRequired = 2 },
         { weight = 909, desc = "Avenger", unit = "M1097 Avenger", side = 2, cratesRequired = 2 },
         { weight = 910, desc = "MLRS", unit = "M1097 Avenger", side = 2, cratesRequired = 2 },
         { weight = 911, desc = "Paladin", unit = "M-109", side = 2, cratesRequired = 2 },
         { weight = 912, desc = "Fuel truck", unit = "M978 HEMTT Tanker", side = 2, cratesRequired = 1 },
         { weight = 913, desc = "Firefighter truck", unit = "HEMTT TFFT", side = 2, cratesRequired = 1 },
